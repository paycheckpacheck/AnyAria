...
if __name__ == "__main__":
    circuit_obj = gerber_circuit()
    circuit_obj.generate_kicad_project(project_name="gerber_circuit", placement_algorithm="hierarchical", generate_pcb=True)
