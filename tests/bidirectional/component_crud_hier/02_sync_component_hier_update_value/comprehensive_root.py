#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 19 - Update component value in subcircuit.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" with R3 (value will change: 1k → 47k)

Test operation: Change R3 value in subcircuit
Expected: R3 value updated, all positions preserved
"""
...
if __name__ == "__main__":
    ...
    print("\n💡 Change R3 value to 47k to test")
