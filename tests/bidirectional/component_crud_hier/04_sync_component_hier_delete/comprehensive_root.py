#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 21 - Delete component in subcircuit.

Hierarchy:
- Root sheet with R1, R2, C1
- Subcircuit "amplifier" with R3, R4 (R4 will be deleted)

Test operation: Delete R4 from subcircuit
Expected: R4 removed, R3 and all root components preserved
"""
...
def amplifier_stage(input_sig, output_sig, vcc, gnd):
    """Amplifier subcircuit with R3 and R4."""
...
if __name__ == "__main__":
    ...
    print("\n💡 Comment out R4 and its connections to test")
