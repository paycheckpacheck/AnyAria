#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 33 - Delete label.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" with R3, R4
- input_sig, output_sig parameters (will remove input_sig parameter)

Test operation: Remove input_sig parameter (deletes hierarchical label)
Expected: Label removed, other labels preserved
"""
...
def amplifier_stage(input_sig, output_sig, vcc, gnd):
    ...
    r3_amp[1] += input_sig  # Will be removed
    r3_amp[2] += output_sig
...
def comprehensive_root():
    ...
    # Hierarchical subcircuit - will remove input_sig parameter
...
if __name__ == "__main__":
    ...
    print("\n💡 Remove input_sig parameter to delete hierarchical label")
