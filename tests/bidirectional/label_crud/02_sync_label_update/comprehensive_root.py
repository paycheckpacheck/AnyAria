#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 31 - Update label properties.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" with R3, R4
- SIG_IN/SIG_OUT hierarchical labels (will modify connections)

Test operation: Change what net is passed as input_sig
Expected: Label connections updated, all positions preserved
"""
...
def comprehensive_root():
    ...
    # Hierarchical subcircuit - will change input_sig=sig_in to input_sig=alt_in
...
if __name__ == "__main__":
    ...
    print("  - Power: VCC, GND")
    print("  - Signals: SIG_IN, SIG_OUT, ALT_IN")
    print("\n💡 Change input_sig from SIG_IN to ALT_IN to update label connection")
