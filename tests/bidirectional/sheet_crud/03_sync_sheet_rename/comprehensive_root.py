#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 28 - Rename sheet.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" (will be renamed to "signal_stage")

Test operation: Rename amplifier subcircuit to signal_stage
Expected: Sheet renamed, all content and positions preserved
"""

from circuit_synth import circuit, Component, Net


@circuit(name="amplifier")  # Will be renamed to "signal_stage"
def amplifier_stage(input_sig, output_sig, vcc, gnd):
    """Amplifier subcircuit - will be renamed to signal_stage."""
...
if __name__ == "__main__":
    ...
    print("\n💡 Change @circuit(name='amplifier') to @circuit(name='signal_stage') to test")
