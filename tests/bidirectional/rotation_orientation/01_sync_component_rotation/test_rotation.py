#!/usr/bin/env python3
"""Test 51: Component Rotation"""
import pytest, subprocess, shutil
from pathlib import Path

def test_51_rotation(request):
    ...
    try:
        ...
        print("\n✅ Test 51 PASSED: Rotation test circuit generated")
        print("   💡 Manual: Rotate R1 in KiCad, regenerate, verify rotation preserved")
    finally:
