#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 11 - Update component value preservation.
...
Test operation: Update R1 value from 10k → 47k
Expected: Only R1 value changes, everything else preserved
"""
...
if __name__ == "__main__":
    ...
    print("\n💡 Change R1 value in code to test preservation")
