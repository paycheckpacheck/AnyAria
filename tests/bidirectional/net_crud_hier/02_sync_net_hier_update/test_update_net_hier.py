#!/usr/bin/env python3
"""
Test 23: Update Net in Subcircuit - Basic Generation Test

Validates that updating a net connection in the amplifier subcircuit
...
def test_23_update_net_hier(request):
    """Test updating net connection in subcircuit - basic generation."""
    ...
    try:
        ...
        print("\n✅ Test 23 PASSED: Hierarchical net update test circuit generated successfully")
