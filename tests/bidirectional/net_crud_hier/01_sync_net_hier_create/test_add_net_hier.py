#!/usr/bin/env python3
"""
Test 22: Add Net in Subcircuit - Basic Generation Test

Validates that adding a CLK net in the amplifier subcircuit
...
def test_22_add_net_hier(request):
    """Test adding CLK net in subcircuit - basic generation."""
    ...
    try:
        ...
        print("\n✅ Test 22 PASSED: Hierarchical net test circuit generated successfully")
