#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 24 - Rename net in subcircuit.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" with R3, R4, CLK net (will be renamed to ENABLE)

Test operation: Rename CLK net to ENABLE
Expected: Net renamed, all connections preserved
"""
...
def amplifier_stage(input_sig, output_sig, vcc, gnd):
    """Amplifier subcircuit with CLK net to be renamed."""
    ...
    clk = Net("CLK")  # Will be renamed to ENABLE
