#!/usr/bin/env python3
"""
Comprehensive root circuit for Test 25 - Delete net in subcircuit.

Hierarchy:
- Root sheet with R1, R2
- Subcircuit "amplifier" with R3, R4, CLK net (will be deleted)

Test operation: Delete CLK net
Expected: CLK net removed, all other elements preserved
"""
...
def amplifier_stage(input_sig, output_sig, vcc, gnd):
    """Amplifier subcircuit with CLK net to be deleted."""
    ...
    clk = Net("CLK")  # Will be deleted

    r3_amp[1] += input_sig
    r3_amp[2] += output_sig

    r4_amp[1] += clk  # Will be removed
    r4_amp[2] += gnd
...
if __name__ == "__main__":
    ...
    print("\n💡 Comment out CLK net and r4_amp[1] connection to test")
