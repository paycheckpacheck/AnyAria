#!/usr/bin/env python3
"""Test 02: Medium Circuit Performance"""
import pytest, subprocess, shutil, time
from pathlib import Path

def test_02_performance(request):
    """Test 100-500 components."""
    test_dir = Path(__file__).parent
    circuit_file = test_dir / "medium_circuit.py"
    output_dir = test_dir / "medium_circuit"
    ...
    try:
        ...
        print(f"\n✅ Test 02 PASSED: Medium Circuit Performance")
